        ...
        if(isset($_POST['loginSubmit']))
        {
            ...
            if($stmt->execute())
            {
                                ...
                                if ($stmt->fetch())
                                {
                                        ...
                                        if ($_SERVER['HTTP_REFERER'] == "http://csis.svsu.edu/~sqi1/startup.html" || $_SERVER['HTTP_REFERER'] == "http://csis.svsu.edu/~tawale/groupProject/login.php" )
                                        {
                                                // Relocate to landing page
                                                header('Location: individua_persons.php');
                                                exit;
                                        }
        ...
        <div class="col-md-4" style="margin-top: 40px;">
                ...
                <div class="panel panel-default" style="box-shadow: 2px 2px 7px #888888;">
                        <div class="panel-heading"><b>Login</b></div>
                                ...
                                <?php
                                        echo '<form method="POST" action="individua_persons.php">
